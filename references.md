...
- WithYouWithMe — Red Team Essentials Capstone, which provided the vulnerable Ubuntu virtual machine used for this assessment.

## Tools

- [Nmap](https://nmap.org/)
- [SearchSploit](https://www.exploit-db.com/searchsploit) / [Exploit-DB](https://www.exploit-db.com/)
